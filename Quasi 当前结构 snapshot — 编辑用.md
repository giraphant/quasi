...
| `citecheck-agent` | 校 draft 引用,主题契合判断 (0.17.0 v2 离线) | (无)                            | wrap-up                         |                                                                |
...
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------- | ------------------------- |
| `/quasi:wrap-up`           | proofread-agent × 节 · citecheck-agent × 批                                                                                           | quasi-proofread · quasi-citation (0.17.0 后 subcommand 变了, SKILL.md **尚未更新**) | draft 收尾(校文字 + 校引用) | SKILL.md 跟 0.17.0 不匹配,要重写 |
