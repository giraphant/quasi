...
- verified 新建或实质更新：complete + `ok,true,true`；
- exact card 无需变化：complete + `unchanged,false,true`；
- 无可核验证据：不写文件，complete + `empty,false,false`，title/evidence 为 null、计数 0、note 非空；
