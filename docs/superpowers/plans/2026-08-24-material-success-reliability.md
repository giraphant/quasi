...
- [x] **Step 1: Write failing CLI and transaction tests**
...
- [x] **Step 3: Implement closed progress parsing and atomic JSON writes**
...
- [x] **Step 4: Implement one-range extraction, validation, and merge**
...
- [x] **Step 5: Verify GREEN and ordinary OCR regression**
...
- [x] **Step 1: Write failing status, request, and plan tests**
...
- [x] **Step 3: Add the catalog and status projection**
...
- [x] **Step 4: Add the specialist and plan contract**
...
- [x] **Step 1: Write failing source-alternative tests**
...
- [x] **Step 3: Change the artifact/status contract**
...
- [x] **Step 4: Change Acquire and Prepare envelopes**
...
- [x] **Step 1: Write failing normalization and HTML tests**
...
- [x] **Step 3: Implement text normalization**
...
- [x] **Step 4: Remove host-name gating from text fallback**
...
- [x] **Step 1: Write failing validation and budget tests**
...
- [x] **Step 3: Implement one readable-PDF predicate**
...
- [x] **Step 4: Implement the deadline**
...
- [x] **Step 5: Map the typed outcome**
...
- [x] **Step 3: Extend the closed contracts**
...
- [x] **Step 4: Implement direct and composed behavior**
...
- [x] **Step 1: Update maintained contracts**
...
- [x] **Step 4: Run complete release gates**
...
- [x] **Step 5: Audit requirements against the spec**
