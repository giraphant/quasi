...
export const BOOK_OPERATION_IDENTITIES = [
  {
    "stage": "search",
    "operation": "material.search",
    "phase": "Search",
...
export const TALK_OPERATION_IDENTITIES = [
  {
    "stage": "prepare",
...
export const TRANSLATION_OPERATION_IDENTITIES = [
  {
    "stage": "prepare",
...
export const TOPIC_OPERATION_IDENTITIES = [
  {
    "stage": "recall",
...
export const AUTHOR_OPERATION_IDENTITIES = [
  {
...
export const PIPELINE = {
  "paper": {
    "stages": PAPER_OPERATION_IDENTITIES,
    "chain": {
      "sequence": [
        "acquire",
        "prepare",
  ...
  "book": {
    "stages": BOOK_OPERATION_IDENTITIES
  },
  "talk": {
    "stages": TALK_OPERATION_IDENTITIES
  },
  "translation": {
    "stages": TRANSLATION_OPERATION_IDENTITIES
  },
  "topic": {
    "stages": TOPIC_OPERATION_IDENTITIES
  },
  "author": {
    "stages": AUTHOR_OPERATION_IDENTITIES
  }
};
