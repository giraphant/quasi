...
export const archiveOperationRows: OperationRow[] = [
  {
    ...
    envelope: (_c, r) => ({
      ...
      capabilities: [
        "quasi-archive inspect --url source_url [--pages PAGE_SELECTION] [--output-dir .quasi/temp/UNIQUE]",
        "quasi-archive inspect --path EXACT_RETURNED_CACHED_PDF [--pages PAGE_SELECTION] [--output-dir .quasi/temp/UNIQUE]",
        "Read exact PDF preview paths returned by inspect for source_url",
        "WebFetch only source_url",
        "quasi-helpers vault resolve --items-json with kind=archive, candidate slug and source_url",
      ],
  ...
  },
  {
    ...
    envelope: (_c, r) => ({
      ...
      capabilities: ["Read exact_output, exact_manifest and observed original paths",
        "quasi-archive inspect --url identity.url (or an exact linked asset selected from that object) [--pages PAGE_SELECTION] [--output-dir .quasi/temp/UNIQUE]",
        "quasi-archive inspect --path EXACT_OBSERVED_OR_RETURNED_PDF [--pages PAGE_SELECTION] [--output-dir .quasi/temp/UNIQUE]",
        "Read exact PDF preview paths returned by inspect for the assigned object",
